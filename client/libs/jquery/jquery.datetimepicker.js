...
(function( $ ) {
	...
	$.fn.datetimepicker2 = function( opt ) {
		var KEY0 = 48,
			KEY9 = 57,
			_KEY0 = 96,
			_KEY9 = 105,
			...
			createDateTimePicker = function( input ) {
				var datetimepicker = $('<div '+(options.id?'id="'+options.id+'"':'')+' '+(options.style?'style="'+options.style+'"':'')+' class="xdsoft_datetimepicker xdsoft_noselect '+options.className+'"><iframe frameborder="no" scrolling="no"></iframe></div>'),
				...
				datetimepicker.setOptions = function( _options ) {
					...
					if( options.inline ) {
						datetimepicker.addClass('xdsoft_inline '+ input.attr('name'));
