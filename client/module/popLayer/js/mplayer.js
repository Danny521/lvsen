...
define(['/module/common/js/player2.js','base.self'],function(){
	...
	var player = {
		...
		initPlayer: function(playParm) {
			...
			var isPlayR = playParm.begintime && playParm.endtime;
			self.timeBegin = isPlayR ? (playParm.begintime - 0):null;
			self.timeEnd = isPlayR ? (playParm.endTime - 0):null;
			...
			self.player.getCameraDataById(self.playParm.cameraId,0,
				function(data){
					self.getHistoryList(self.player.findcamid(data),callback_1)
				})
		...
		getHistoryList:function(channelId,callback){
			...
			jQuery.ajax({
				...
				success: function(res)
				{
					...
					{
						/*videoPlayParm:{
						 "videos":[[1436847636000,1436851689000,1],[1436851689000,1436855740000,1],[1436855740000,1436857990000,1]],
						 "name":"内部监控_21",
						 "type":2,/!*历史录像*!/
						 "user":"TMR29YtnGPI=",/!*用户名*!/
						 "passwd":"TMR29YtnGPI=",/!*密码*!/
						 "ip":"cmYcQh14L8XD5b5wUvPobg==",/!*PVG服务器的IP或者DNS*!/
						 "port":2100,/!*PVG服务器的IP或者DN*!/
						 "path":'fVKIY3NgAxAooUfBVQwJcg==',/!*Av对象名*!/
						 "vodType":1,/!*通道深度*!/
						 "time":1436856806899,
						 "beginTime":1436855740000,
						 "endTime":1436857990000,
						 "displayMode":0,/!*eg*!/
						 }*/
						var camera =res.data;
		...
		updateTimeDisplay:function(){
			...
			if (self.enableUpdateTime) {
				...
				console.log("nowTime: ", nowTime, "allTime: ", allTime)
				if(nowTime>=allTime){
