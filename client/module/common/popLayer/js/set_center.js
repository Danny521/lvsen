    ...
    var set_center =  {
        ...
        picReset:function(src){
            ...
            img.onload=function(){
                ...
                state._originWidth = self.bgPicSize.width;//state.width;
                state._originHeight = self.bgPicSize.height;//state.height
                setTimeout(function(){
                    jQuery(".big-pic").css({
                        "height":state.height,
                        "width":state.width
        ...
        refreshTransform : function(){
            var state = this.state,
                transformValue = "scale(" + state.scale * state.horizontal + "," + state.scale * state.vertical + ") rotate(" + state.rotate + "deg)",
                styleObj = {
                    "width": state.width,
                    "height": state.height,
                    "left": state.posX,
            ...
            styleObj["-webkit-transform"] = transformValue;
            styleObj["-o-transform"] = transformValue;
            styleObj["-ms-transform"] = transformValue;
            styleObj["-moz-transform"] = transformValue;

            jQuery(".big-pic").css(styleObj).show();
        },
