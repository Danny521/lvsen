...
public class OrderController {
	...
	@ApiOperation(value = "获取全部单据列表", notes = "获取全部单据的列表")
	@GetMapping(path = "/all")
	@ResponseBody
	...
	@ApiOperation(value = "获取单据列表", notes = "获取全部单据的列表")
	@GetMapping(path = "/list")
	@ResponseBody
	public ApiResponseInfo list(HttpServletRequest request,
			@ApiParam(name = "key", value = "单据名称关键字", required = false) String key,
	...
	@ApiOperation(value = "搜索单据列表", notes = "根据关键字搜索单据的列表")
	...
	@ApiOperation(value = "添加进货订单单据信息", notes = "添加新增单据的详细信息")
	...
	public ApiResponseInfo add(HttpServletRequest request,
			...
			@ApiParam(name = "discount", value = "整单折扣", required = true) Float discount,
			@ApiParam(name = "digest", value = "摘要信息", required = true) String digest,
	...
	@ApiOperation(value = "修改单据信息", notes = "修改新增单据的详细信息")
	...
	@ApiOperation(value = "获取单据详细信息", notes = "根据指定ID获取单据的详细信息")
	@GetMapping(path = "/{id}")
	@ResponseBody
